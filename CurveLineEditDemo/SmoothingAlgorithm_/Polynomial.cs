...
namespace CurveLineEditDemo
{
    ...
    /// 多项式
    /// </summary>
    internal class Polynomial : ICloneable
    {
        /// <summary>
        /// m_c.长-1次多项式的系数
        /// 系数从最低到最高(即c[0]是自由成员)。
        ...
        /// 多项式
        /// </summary>
        /// <param name="c">c.长-1次多项式的系数；系数从最低到最高(即c[0]是自由的)。</param>
        ...
        public double this[int i] => m_c[i];
        ...
        /// as pd[1..nd].
        /// </remarks>
        /// <param name="c">nc+1 coefficients of a polynomial of degree nc;
        ...
        {
            //如果这个多项式有零的低阶系数，那么它有平凡的零根；在解之前应该排除它们。
            //求第一个非零系数
            int n = 0;
